...
struct MTColumnDescriptor {
  ...
  5:string bloomFilterType = "NONE",
  6:i32 minVersions = 0,
  7:bool blockCacheEnabled = 0,
  8:i32 timeToLive = -1,
  9:i32 blockSize = 65536
}
 ...
 * Add by lijianbin
 */
struct TRowResultWithMultiColVer {
  1:Text row,
  2:optional map<Text, list<TCell>> columns,
  3:optional list<TColumn> sortedColumns
}
...
service Hbase {
  ...
  void MTCreateTable(
    ...
    /** name of table to create */
    2:list<Text> splitKeys,

    /** list of column family descriptors */
    3:list<MTColumnDescriptor> columnFamilies
  ) throws (1:IOError io, 2:IllegalArgument ia, 3:AlreadyExists exist)
  ...
  void MTAddColumn(
    ...
    /** list of column family descriptors */
    2:list<MTColumnDescriptor> columnFamilies
  ...
  void MTDeleteColumn(
    ...
    /** name of column family to delete */
   ...
   * @return TRowResult containing the row and map of columns to TCells
   */
  list<TRowResultWithMultiColVer> getRowWithColumnsMaxVer(
    /** name of table */
    1:Text tableName,
   ...
   * @return TRowResult containing the row and map of columns to TCells
   */
  list<TRowResultWithMultiColVer> getRowWithColumnsTsMaxVer(
    /** name of table */
    1:Text tableName,
